            ...
            <div class="banner-content wow fadeInUp delay-0-2s">
                ...
                <div class="mt-32">
                    <ul class="breadcrumb wow fadeInUp delay-0-4s">
                        <li class="breadcrumb-item"><a href="index-light.php">Home</a></li>
        ...
        <div class="row project-active">
            ...
            <div class="col-md-12 item LANDSCAPE">
                ...
                <div class="row detail-images align-items-center wow fadeInLeft delay-0-1s">
                    <a href="project-details-light.php"><img src="assets/images/projects/img-6.png" alt="project"></a>
                </div>
            </div>
            <div class="col-md-12 item INTERIOR">
                <div class="row wow fadeInRight delay-0-1s rp-0">
                ...
                <div class="row detail-images gap-30 align-items-center wow fadeInLeft delay-0-1s">
                    <div class="col-md-6">
                        <a href="project-details-light.php"><img src="assets/images/projects/img-7.png" alt="project"></a>
                    </div>
                    <div class="col-md-6">
                        <a href="project-details-light.php"><img src="assets/images/projects/img-8.png" alt="project"></a>
                    </div>
                </div>
            </div>
        </div>
